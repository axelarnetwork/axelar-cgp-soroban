...
pub(crate) fn approve_contract_call(env: &Env, command_id: BytesN<32>, source_chain: String, source_address: String, contract_address: Address, payload_hash: BytesN<32>) {
    let topics = (symbol_short!("approved"), command_id, contract_address, payload_hash);
