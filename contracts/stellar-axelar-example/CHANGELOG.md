...
## [1.0.11](https://github.com/axelarnetwork/axelar-amplifier-stellar/compare/stellar-axelar-example-v1.0.10...stellar-axelar-example-v1.0.11)
...
- Updated the following local packages: stellar-interchain-token-service, stellar-interchain-token-service, stellar-axelar-std, stellar-axelar-std, stellar-axelar-gas-service, stellar-axelar-gas-service, stellar-axelar-gateway, stellar-axelar-gateway - ([0000000](https://github.com/axelarnetwork/axelar-amplifier-stellar/commit/0000000))

## [1.0.8](https://github.com/axelarnetwork/axelar-amplifier-stellar/compare/stellar-axelar-example-v1.0.7...stellar-axelar-example-v1.0.8)
